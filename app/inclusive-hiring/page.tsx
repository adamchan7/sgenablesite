...
export default function InclusiveHiringPlaceholder() {
  return (
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-2xl mx-auto">
          <div className="w-24 h-24 bg-primaryBlue/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <BarChart3 className="h-12 w-12 text-primaryBlue" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Extent of Inclusive Hiring
          </h1>
          <p className="text-lg text-gray-600 mb-8">
            Coming soon! This pillar will help you baseline and prove your hiring impact through data.
          </p>
